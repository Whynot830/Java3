package com.example.pw16.Controllers;

import com.example.pw16.Services.TableService;
...
public class PostOfficeController {
    ...
    public ResponseEntity<List<Departure>> getAllDeparturesByOffice(@PathVariable("id") Integer id) {
        final List<Departure> departures = tableService.readOneEntity(id).getDepartures();
