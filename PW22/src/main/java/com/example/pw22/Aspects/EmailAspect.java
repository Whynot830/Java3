//package com.example.pw22.Aspects;
//
//import com.example.pw22.Services.EmailService;
...
//    }
//
//    @Pointcut("execution(* com.example.pw22.Services.*.createEntity(..)) || execution(* com.example.pw22.Services.*.updateEntity(..))")
