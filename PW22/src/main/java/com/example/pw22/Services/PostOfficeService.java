...
import com.example.pw22.Repos.PostOfficeRepo;
...
@Service
@Slf4j
public class PostOfficeService extends AbstractTableService<PostOffice> {
    public PostOfficeService(JpaRepository<PostOffice, Long> repo) {
        super(repo);
    }
